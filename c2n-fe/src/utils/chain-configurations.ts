...
export const chainConfigurations = [
  ...
  },
  {
    ...
    rpc: ["https://rinkeby.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161", "wss://rinkeby.infura.io/ws/v3/9aa3d95b3bc440fa88ea12eaa4456161"],
  ...
  },
  {
    ...
    rpc: ["https://goerli.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161", "wss://goerli.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161", "https://rpc.goerli.mudit.blog/"],
  ...
  },
  {
    ...
    rpc: ["https://songbird.towolabs.com/rpc", "https://sgb.ftso.com.au/ext/bc/C/rpc", "https://sgb.lightft.so/rpc", "https://sgb-rpc.ftso.eu"],
    faucets: [],
    infoURL: "https://flare.xyz",
  },
  {
...
export const getChainConfiguration = (chainId: number = CHAIN_ID) => {
  return chainConfigurations.find((chainConfiguration) => {
    return chainConfiguration.chainId === chainId;
  })!;
};
 ...
 * @returns string[]
 */
export const getChainRPCS = (chainId: number = CHAIN_ID) => {
  return getChainConfiguration(chainId).rpc;
};
 ...
 * @returns string
 */
export const getChainRPCRandom = (chainId: number = CHAIN_ID) => {
